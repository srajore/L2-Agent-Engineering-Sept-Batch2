# Session 5 Trainer Guide — Tool Integration

## Outcome

By the end of the session, a learner can run one file and explain how it helps them call one plain Python function from a fixed workflow.
