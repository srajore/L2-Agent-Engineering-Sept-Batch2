# Session 4 Trainer Guide — Routing and Control Flow

## Outcome

By the end of the session, a learner can run one file and explain how it helps them route with developer-written conditions.
