# Session 6 Trainer Guide — From Workflow to Agent

## Outcome

By the end of the session, a learner can run one file and explain how it helps them let the model choose one of two validated actions.
